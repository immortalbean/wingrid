...
class _Window:
    ...
    def get_element(self, element: str):
        if element in self.elements:
            ...
            caller = inspect.stack()[1]
            print(f"[WinGrid] Warning: Element {element} does not exist. Check your code for typos or inconsistencies. (line {caller.lineno} in {caller.filename})",file=sys.stderr)
            return None
